...
set :linked_dirs, %w{bin log tmp/pids tmp/cache tmp/sockets vendor/bundle public/system public/uploads public/img config/server_init}
  ...
  namespace :check do
    before :linked_files, :set_file do
      on roles(:app), in: :sequence, wait: 10 do
        ...
        execute 'curl -fsSL https://github.com/rbenv/rbenv-installer/raw/HEAD/bin/rbenv-doctor | bash'
